...
export const REQUEST_GET_HOSTED_SESSIONS_TODAY = `${REQUEST_GET_ALL_SESSIONS_TODAY}/hosted`
export const REQUEST_GET_JOINED_SESSIONS_TODAY = `${REQUEST_GET_ALL_SESSIONS_TODAY}/joined`
